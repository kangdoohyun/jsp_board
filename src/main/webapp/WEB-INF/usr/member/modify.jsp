		...
		<div class="card bordered shadow-lg">
			...
			<div class="px-4 py-4">
				...
				<form action="../member/doModify" method="GET" onsubmit="MemberModify__submit(this); return false;">
					...
					<div class="btns">
						<button id="modify-submit" type="submit" class="btn btn-link" value="0">수정완료</button>
					</div>
				</form>
			</div>
		</div>
