...
<c:set var="pageTitle" value="관리자 로그인" />
			...
			<div class="px-4 py-4">
				...
				<form action="../member/doLogin" method="POST"
					...
					<div class="form-control">
						<label class="label">
							<span class="label-text">관리자아이디</span>
						</label>
						<div>
							<input class="input input-bordered w-full" maxlength="100"
								name="loginId" type="text" placeholder="관리자아이디를 입력해주세요." value="${param.loginId}" />
						</div>
					</div>

					<div class="form-control">
						<label class="label">
							<span class="label-text">관리자비밀번호</span>
						</label>
						<div>
							<input class="input input-bordered w-full" maxlength="100"
								name="loginPw" type="password" placeholder="관리자비밀번호를 입력해주세요." />
						</div>
					</div>
